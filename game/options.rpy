...
define config.name = _("Shadow of the Forgotten Forest")
...
define build.name = "ShadowoftheForgottenForest"
...
define config.save_directory = "ShadowoftheForgottenForest-1772104698"
